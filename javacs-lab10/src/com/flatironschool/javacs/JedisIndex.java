...
public class JedisIndex {
	...
	public Set<String> getURLs(String term)
	{
        ...
        //URLset.add(arg0)
		String setName = urlSetKey(term); //this shouldreturn the URLSet for a given term
	...
	public Map<String, Integer> getCounts(String term)
	{
		...
		// FILL THIS IN!
		//This should return the TermCounter for a gien term
	}
	...
	public void indexPage(String url, Elements paragraphs)
	{
		...
		// for each term in the TermCounter, add the TermCounter to the redis hash(?)
		for (String term: tc.keySet())
		{
			jedis.hset(key, term, Integer.toString(tc.get(term)));
			String setName = urlSetKey(term);
